        ...
        <section ref={containerRef} className="py-40 px-6 bg-[#fcfcfc] relative">
            ...
            <div className="max-w-7xl mx-auto relative z-10">
                <div className="mb-12 md:mb-24 text-center px-4">
                    ...
                    <h2 className="text-4xl sm:text-6xl md:text-8xl font-serif font-bold mt-4 md:mt-6 tracking-tighter leading-tight">Engineered for Trust</h2>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
                    {[
                        ...
                        <div
                            key={idx}
                            className="solution-card bg-white p-8 md:p-14 rounded-[2rem] md:rounded-[3rem] border border-gray-100 group hover:border-[#A3FF00] transition-all duration-500 shadow-sm hover:shadow-2xl hover:shadow-[#A3FF00]/10"
                        >
                            <div className="mb-6 md:mb-10 p-4 md:p-5 bg-black text-[#A3FF00] w-fit rounded-xl md:rounded-2xl group-hover:scale-110 transition-transform duration-500">
                                {item.icon}
                            </div>
