        ...
        <section ref={containerRef} className="relative py-20 px-6 overflow-visible">
            <div className="max-w-6xl mx-auto">
                <div className="browser-window relative bg-[#f8f9fa] rounded-3xl border border-gray-200 shadow-[0_50px_100px_-20px_rgba(0,0,0,0.15)] overflow-hidden">
                    ...
                    <div className="p-6 md:p-10 bg-[#fdfdfd] grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-8">
                        <div className="md:col-span-4 space-y-4 md:space-y-6">
                            <div className="h-28 md:h-32 bg-white rounded-2xl border border-gray-100 p-5 md:p-6 flex flex-col justify-between">
                                <div className="text-[10px] font-black uppercase text-gray-400 tracking-widest">Refund Request</div>
                                <div className="text-xl md:text-2xl font-serif font-bold">#RFC-88293</div>
                                <div className="h-1 w-full bg-gray-100 rounded-full overflow-hidden">
                                    <div className="h-full w-2/3 bg-[#A3FF00]" />
                                </div>
                            </div>
                            <div className="h-40 md:h-48 bg-black rounded-2xl p-5 md:p-6 flex flex-col justify-between text-[#A3FF00]">
                                <div className="text-[10px] font-black uppercase tracking-widest opacity-60">Status</div>
                                <div className="text-2xl md:text-3xl font-serif font-bold italic">Processing.</div>
                                <div className="text-[10px] md:text-xs text-white/40 leading-relaxed font-light">
                                    Cancellation verified. <br />
                                    Refund initiated to original mode.
                                </div>
                            </div>
                        </div>
                        <div className="md:col-span-8 bg-white rounded-2xl border border-gray-100 p-6 md:p-8">
                            ...
                            <div className="relative h-32 md:h-40 flex items-center justify-between px-6 md:px-12">
                                ...
                                <div className="relative z-10 w-2 h-2 rounded-full bg-gray-200" />
                                <div className="relative z-10 w-5 h-5 md:w-6 md:h-6 rounded-full bg-[#A3FF00] flex items-center justify-center">
                                    <div className="w-1.5 h-1.5 md:w-2 md:h-2 rounded-full bg-black animate-ping" />
                                </div>
                            </div>
                            <div className="mt-6 md:mt-8 text-center text-[10px] md:text-xs text-gray-400 font-light px-2">
