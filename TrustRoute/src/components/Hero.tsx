...
const Hero: React.FC = () => {
    ...
    return (
        ...
        >
            <div ref={contentRef} className="max-w-6xl z-10 w-full">
                <div className="hero-badge inline-flex items-center gap-2 px-4 py-2 bg-black text-[#A3FF00] rounded-full text-[10px] font-black uppercase tracking-[0.2em] mb-8 md:mb-12 border border-black/10 shadow-xl">
                    <span className="w-2 h-2 bg-[#A3FF00] rounded-full animate-pulse" />
                    Built for Intercity Travel
                </div>

                <h1
                    className="hero-title text-5xl sm:text-6xl md:text-7xl lg:text-[8rem] xl:text-[9rem] font-serif font-bold leading-[0.9] md:leading-[0.85] tracking-tighter mb-8 md:mb-12 text-black"
                >
                    The transparency your <br />
                    <span className="italic text-gray-300">refund is missing.</span>
                </h1>

                <div className="hero-sub max-w-3xl mx-auto mb-10 md:mb-16">
                    <p className="text-lg sm:text-xl md:text-2xl text-gray-600 font-light leading-relaxed mb-6">
                        No hidden rules. No confusion. Just clear, <br className="hidden sm:block" />
                        accountable refund tracking for every bus ticket.
                    </p>
                    <div className="hero-meta flex flex-wrap justify-center gap-4 md:gap-8 text-[9px] md:text-[11px] font-bold text-gray-400 uppercase tracking-widest mt-8 md:mt-12">
